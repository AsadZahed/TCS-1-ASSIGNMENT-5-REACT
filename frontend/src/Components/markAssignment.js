...
export default function Mark() {
    ...
    const getSubmissions = (id) => {
        axios.get('http://localhost:3001/users/getsubmission/' + String(id), {
            headers: {
                'Access-Control-Allow-Origin': '*',
                'Access-Control-Allow-Methods': 'GET,PUT,POST,DELETE,PATCH,OPTIONS',
            }
    ...
    const updateMarks = (marks, id) => {
        ...
        axios.patch('http://localhost:3001/users/updatemarks', data, {
            headers: {
                'Access-Control-Allow-Origin': '*',
                'Access-Control-Allow-Methods': 'GET,PUT,POST,DELETE,PATCH,OPTIONS',
            }
            ...
            <div style={{ backgroundColor: "#F8F8F8" }}>
                ...
                >
                    ...
                    >
                        ...
                        <h2 style={{borderBottom:"2px solid black", textAlign:"center"}}>Select Assignment you want to mark</h2>
                        <table>
                            <tr>
                                <td>No.</td>
                                <td>Name</td>
